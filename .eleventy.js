...
const sliderDep = require("./src/_includes/widgets/slide.js");
...
module.exports = function(eleventyConfig) {
  ...
  */
  ...
  eleventyConfig.addFilter("spotifyShare2Embed", url => {
    return url.replace('.com/', '.com/embed/');
  });
  
  eleventyConfig.addFilter("lookBtwn", (str, first, second) => {
    return str.substring(str.indexOf(first) + 1, str.lastIndexOf(second)).replace(first.substring(1), '');
  });
  ...
  eleventyConfig.addCollection("posts", function(collection) {
    ...
    */
    ...
    const coll = collection
      .getFilteredByTag("posts").reverse();
